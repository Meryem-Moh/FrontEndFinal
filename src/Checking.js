...
const url= "/AccountHolders/{id}/DBACheckingAccounts";
  ...
  return (
    <div>
      ...
      <ReactBootStrap.Nav.Link js-scroll-trigger a href="/Personalchecking">
           Click here to Open Personal Checking Account
            </ReactBootStrap.Nav.Link>

      <ReactBootStrap.Nav.Link js-scroll-trigger a href="/Dba">
           Click here Open DBA- Checking Account
            </ReactBootStrap.Nav.Link>
