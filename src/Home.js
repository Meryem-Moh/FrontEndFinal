                ...
                <div className="row">
                  ...
                  <div className="col-sm-4">
                    <div className="team-member">
                      ...
                      <h5 className="text-muted">Team Lead/Backend Developer</h5>
                  ...
                  <div className="col-sm-4">
                    <div className="team-member">
                      ...
                      <h5 className="text-muted">Backend Developer</h5>
                      <ul className="list-inline social-buttons">
                        <li className="list-inline-item">
                  ...
                  <div className="col-sm-4">
                    <div className="team-member">
                      ...
                      <h5 className="text-muted">Frontend/Backend Developer</h5>
                      <ul className="list-inline social-buttons">
                        <li className="list-inline-item">
