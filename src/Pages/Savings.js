    ...
    return (
     <div>
      ...
      <div>
        ...
        <form onSubmit={(event) => this.handleSubmitID(event,"SavingsAccounts")}>
          ...
          <input className = 'input' type='number' placeholder = {this.state.balance} name='Balance' onChange={this.handleChange}/>   
