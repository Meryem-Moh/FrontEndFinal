...
//THIS IS TO SET THE BALANCE AND DISPLAY IT LATER
      this.setState({
        balance: bal
      })
  ...
  render() {
    return (
     <div>
      ...
      <div>
        <form onSubmit={(event) => this.handleSubmitID(event,"CDAccounts")}>
          <h3>Your Balance </h3>
          <ListGroup className = 'card'>

          <input className = 'input' type='number' placeholder = {this.state.balance} name='id' onChange={this.handleChange}/> 
