        ...
        <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
          <ReactBootStrap.Nav className="mr-auto">
            ...
            >
              ...
              <ReactBootStrap.NavDropdown.Item href="/cd">
                Certificate of Deposits Account (CD)
              </ReactBootStrap.NavDropdown.Item>
              <ReactBootStrap.NavDropdown.Divider />
              <ReactBootStrap.NavDropdown.Item href="ira">
                Individual Retirement Accounts (IRA)
              </ReactBootStrap.NavDropdown.Item>
            </ReactBootStrap.NavDropdown>
          </ReactBootStrap.Nav>
          <ReactBootStrap.Nav>
            <ReactBootStrap.Nav.Link js-scroll-trigger href="/register">
              Create a New Account
            </ReactBootStrap.Nav.Link>
            <ReactBootStrap.Nav.Link js-scroll-trigger a href="/aboutus">
              About Us
            </ReactBootStrap.Nav.Link>
